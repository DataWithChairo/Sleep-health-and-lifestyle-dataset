--Creating a table for the Sleep Health and Lifestyle dataset
CREATE TABLE health (
...
sleep_disorder VARCHAR(20) NOT NULL);


--selecting the table to see if the structure is correct
SELECT * FROM health;

--Inserting Values from the excel csv file using the import/export tool
...
33,Female,31,Nurse,7.9,8,75,4,Normal ,117/76,69,6800,None
...
67,Male,32,Accountant,7.2,8,50,6,Normal ,118/76,68,7000,None
...
85,Male,35,Software Engineer,7.5,8,60,5,Normal ,120/80,70,8000,None
...
93,Male,35,Software Engineer,7.5,8,60,5,Normal ,120/80,70,8000,None
...
108,Male,37,Engineer,7.8,8,70,4,Normal ,120/80,68,7000,None
109,Male,37,Engineer,7.8,8,70,4,Normal ,120/80,68,7000,None
...
126,Female,37,Nurse,7.5,8,60,4,Normal ,120/80,70,8000,None
...
149,Female,39,Lawyer,6.9,7,50,6,Normal ,128/85,75,5500,None
150,Female,39,Accountant,8,9,80,3,Normal ,115/78,67,7500,None
151,Female,39,Accountant,8,9,80,3,Normal ,115/78,67,7500,None
...
162,Female,40,Accountant,7.2,8,55,6,Normal ,119/77,73,7300,None
163,Female,40,Accountant,7.2,8,55,6,Normal ,119/77,73,7300,None
...
167,Male,41,Engineer,7.3,8,70,6,Normal ,121/79,72,6200,None
...
204,Male,43,Engineer,6.9,6,47,7,Normal ,117/76,69,6800,None
...
303,Female,51,Nurse,7.1,7,55,6,Normal ,125/82,72,6000,None
...
342,Female,56,Doctor,8.2,9,90,3,Normal ,118/75,65,10000,None
343,Female,56,Doctor,8.2,9,90,3,Normal ,118/75,65,10000,None
